    ...
    <section className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <p className="max-w-3xl text-base text-white/70">
          Every screen we ship must respect the rules in <strong>DEV.md</strong>: App Router shell
          only, domain logic in feature modules, and shared capabilities inside Core. TEX connects
          attractions, food, shopping, timing, and geography into one AI-assisted flow that can grow
          without refactors.
        </p>
        <ul className="space-y-3 text-base text-white/80">
          ...
          <li>
            • Feature modules (Trip Planner, City Catalog, User Profile, AI Planner) export a single
            public surface.
          </li>
        </ul>
      </div>
